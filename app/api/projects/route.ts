...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await query(
      `INSERT INTO projects (name, target_url, style, planning_model, coder_model, qa_model)
       VALUES ($1, $2, $3, $4, $5, $6)
       RETURNING id, name, target_url, style, planning_model, coder_model, qa_model, created_at`,
      [name, targetUrl || '', style || '', planningModel || '', coderModel || '', qaModel || '']
    );
